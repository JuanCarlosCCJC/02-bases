...
@Component({
  ...
  imports: [contadorComponent, HeroeComponent, InstitutoComponent, ListaComponent, Instituto2Component] //Aqui añado el componente y asi lo puedo usar en el HTML
